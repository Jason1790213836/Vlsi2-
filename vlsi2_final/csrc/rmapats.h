...
typedef struct hybridSimInfoT {
    ...
    void * I934;
    U  * I935;
    struct hybridSimReferrerData * I936;
    struct hybridSimReferrerData * I938;
} hybridSimInfoT;
...
typedef struct _RmaMultiInputTable {
    ...
    UB  * I986;
    UB  * I987;
    struct _RmaMultiInputTable * I960;
    struct _RmaMultiInputTable * I989;
} RmaMultiInputTable;
...
typedef struct {
    ...
    U  I1078;
    U  I1079;
    HsimSignalMonitor  * I1080;
    RP  I1081;
    RmaTimeStamp64  I649;
    U  I1082;
    RmaTimeStamp64  I1083;
    U  I1084;
    UB  I1085 :1;
    UB  I1086 :1;
    UB  I1087 :1;
...
typedef struct {
    U  I652;
    U  I660;
    RmaThreadSchedCompiledLoads  * I1113;
...
typedef struct {
    ...
    US  I1180;
    RP  I1181;
    RemoteDbsedLoad   I1182[1];
} RmaRtlEdgeBlock;
typedef struct TableAssign_ {
    struct TableAssign_ * I960;
...
typedef struct TableAssignLayoutOnClk_ {
    struct TableAssignLayoutOnClk_ * I960;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    struct TableAssignLayoutOnClkOpt_ * I960;
    ...
    U  I1197 :1;
    U  I984 :9;
    RmaSeqPrimOutputOnClkOpt  I1199;
    RmaSeqPrimOutputEblkData  I1203;
...
struct dummyq_struct {
    ...
    struct futq * I1316;
    struct futq * I1317;
    struct sched_table * I1318;
    struct futq_info * I1320;
    struct futq_info * I1322;
    U  I1323;
    U  I1324;
    U  I1325;
    U  I1326;
    ...
    EBLK  * I1379;
    int I1380;
    struct vcs_globals_t * I1381;
    clock_struct  I1383;
    unsigned long long I1384;
    EBLK  * I1385;
    EBLK  * I1386;
    void * I1387;
...
void  rmaPropagate0_f_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1430, U  did);
...
void  rmaPropagate1_f_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1430, U  did);
...
void  rmaPropagate2_f_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1430, U  did);
...
void  rmaPropagate3_f_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1430, U  did);
...
void  rmaPropagate4_f_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1430, U  did);
...
void  rmaPropagate5_f_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1430, U  did);
