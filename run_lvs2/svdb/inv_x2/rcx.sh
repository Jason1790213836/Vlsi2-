#!/eda/cadence/QUANTUS251/tools.lnx86/extraction/bin/64bit/assura_rcx -V
# This script was generated Wed Apr 29 20:45:45 2026 by:
#
# Program: /eda/cadence/QUANTUS251/tools.lnx86/extraction/bin/64bit/RCXspice
# Version: 25.1.0-p047
# Created: Thu Dec 11 23:20:30 PST 2025
#
#/eda/cadence/QUANTUS251/tools.lnx86/extraction/bin/64bit/RCXspice -techdir \
#	/ip/cadence/gpdk045/gpdk045_v_6_0/qrc/rcworst -newlvs \
#	/home/lx2349/vlsi2/run_lvs2/svdb/inv_x2.lvsfile -rcxdir \
#	/home/lx2349/vlsi2/run_lvs2/svdb/inv_x2 -xy_coordinates C,R,D,M,Q,X \
#	-xdspf -type full -temperature 25.0 -tempdir \
#	/home/lx2349/vlsi2/run_lvs2/svdb/inv_x2/rcx_temp -res_models yes \
#	-parasitic_res_models comment -parasitic_cap_models yes \
#	-output_net_name_space layout -output \
#	/home/lx2349/vlsi2/run_lvs2/svdb/inv_x2/rcx.sp -net_name_space layout \
#	-minR 0.001 -minC_by_percentage 0.1 -minC 1e-17 -max_fracture_length \
#	infinite -m_factorR infinite -lvs_source hcci \
#	-ignore_gate_diffusion_fringing_cap -hcci_run_name inv_x2 \
#	-hcci_run_dir /home/lx2349/vlsi2/run_lvs2/svdb -hcci_net_prop 5 \
#	-hcci_inst_prop 6 -hcci_dev_prop 7 -fracture_length_units MICRONS \
#	-extract both -cap_models yes -cap_ground VSS -cap_extract_mode \
#	coupled -cap_coupling_factor 1.0 -array_vias_spacing auto \
#	-agds_layer_map_file /home/lx2349/vlsi2/run_lvs2/svdb/inv_x2.gds.map \
#	-add_bulk_terminal yes -ev2 -cell_name inv_x2 -view_name layout \
#	-extracted_view sv_extracted -lib_name ece6443lib -extview_rule \
#	/ip/cadence/gpdk045/gpdk045_v_6_0/pvs/extview.rul -corner rcx_worst
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
...
##HCCI_NET_PROP=5
##HCCI_RULE_FILE=
##HCCI_RUN_DIR=/home/lx2349/vlsi2/run_lvs2/svdb
...
##NETS_FILE=/dev/null
##NP=1
##OUTPUT=/home/lx2349/vlsi2/run_lvs2/svdb/inv_x2/rcx.sp
...
##RC_FREQUENCY=
##RCXDIR=/home/lx2349/vlsi2/run_lvs2/svdb/inv_x2
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/lx2349/vlsi2/run_lvs2/svdb/inv_x2/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/lx2349/vlsi2/run_lvs2/svdb/inv_x2/inv_x2.gnx,/home/lx2349/vlsi2/run_lvs2/svdb/inv_x2/inv_x2.gdx
...
setTempDir /home/lx2349/vlsi2/run_lvs2/svdb/inv_x2/rcx_temp
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
CAP_COEFF_MR=TRUE
export CAP_COEFF_MR
cd /home/lx2349/vlsi2/run_lvs2/svdb/inv_x2
...
agds2rcx -V -H satfile -r /home/lx2349/vlsi2/run_lvs2/svdb/inv_x2/inv_x2.xcn \
	-split_float_exclude_layers \
	ndiff_0conn,pdiff_0conn,nwell_0conn,psubstrate -crundir \
	/home/lx2349/vlsi2/run_lvs2/svdb -unit meters -xgl -sv -pl \
	inv_x2.ports -f inv_x2.alm -lnn inv_x2.lnn -pnet 5 -pinst 6 -pdev 7 \
	inv_x2.agf inv_x2_pin_xy.spi
...
createEmptyLayer -h fsHierEmptyLayer
...
flattenLayers -m cont_0poly cont_0pdiff_metal1_0conn_pdiff_0conn cont_0ndiff_metal1_0conn_ndiff_0conn ptap ntap cont_0pdiff cont_0ndiff
...
mergevia -V -tech /ip/cadence/gpdk045/gpdk045_v_6_0/qrc/rcworst -cnt \
...
mergevia -V -i -tech /ip/cadence/gpdk045/gpdk045_v_6_0/qrc/rcworst -cnt \
...
rex -V -m -pd -I'#' -l slab -tech \
	/ip/cadence/gpdk045/gpdk045_v_6_0/qrc/rcworst -map p2elayermapfile \
	-wee p2elayermapfile -N NET -Ply np_rpoly_0conn -er \
	np_rmetal1_0conn,metal1_conn.den -rP res.mod \
...
#restore tsv region orig layers
...
/bin/cp ndiff_0conn ndiff_0conn_borig
...
/bin/cp nwell_0conn nwell_0conn_borig
...
reconnect -V -n NET -xdspfb -I'#' -se2 mwires.res -mf -t \
	_0nmos1v.trans:_0nmos1v.transr _0nmos1v \
...
geom _0nmos1v,_0pmos1v - qrcgate,1,i,1
createEmptyLayer via10_nocap
createEmptyLayer via10_cap
createEmptyLayer Via9
createEmptyLayer Via8
createEmptyLayer Via7
createEmptyLayer Via6
createEmptyLayer Via5
createEmptyLayer Via4
createEmptyLayer Via3
createEmptyLayer Via2
createEmptyLayer Via1

#==========================================================#
# Prepare via layers for sip
#==========================================================#

geom -V rcont_0poly - cont_poly,1,i,1
geom -V rcont_0pdiff_metal1_0conn_pdiff_0conn - cont_pdiff,1,i,1
geom -V rcont_0ndiff_metal1_0conn_ndiff_0conn - cont_ndiff,1,i,1
...
sip -V -cgnd ${CAP_GROUND} -s -o -sub 2 -cp poly_conn,allGate,Oxide -n 0.9 -i \
	0,0.901 -b Oxide,FOX -t \
	...
	-j 0.045 -Maxw 1.35 -p poly_conn,key 0,0.9 - poly_conn.sip
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R metal2_conn -b Oxide,FOX -t \
	metal3_conn,metal4_conn,metal5_conn,metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
	-k metal1_conn:0.173 -Maxw 1.8 -p \
...
pax16 -V -lee_off -delete_unused_files rm_files_in_pax16 -gnd ${CAP_GROUND} \
	-via \
	via10_nocap,via10_cap,Via9,Via8,Via7,Via6,Via5,Via4,Via3,Via2,Via1,cont_poly,cont_pdiff,cont_ndiff \
	-rmselfC -ignore_cf_table -scf sip.cmd -rcxlvs rcxtolvsmapfile \
	-M_perim_off -c \
	/ip/cadence/gpdk045/gpdk045_v_6_0/qrc/rcworst/qrcTechFile -f FOX \
	...
	/ip/cadence/gpdk045/gpdk045_v_6_0/qrc/rcworst/qrcTechFile - - NET - \
	capfile
...
xreduce -V -mergecap -n NET -tech \
	/ip/cadence/gpdk045/gpdk045_v_6_0/qrc/rcworst -xdspf -d1 -mfactorR \
	infinite -g ${CAP_GROUND},1.0 -danglingR -minR 0.001 -rPvia \
	...
	-minCper 0.1 -cap capfile slab L1T0 _0nmos1v.transr _0pmos1v.transr

#==========================================================#
# Generate X-DSPF netlist
#==========================================================#

/bin/mv _0nmos1v_orig _0nmos1v
/bin/mv _0pmos1v_orig _0pmos1v
qrcToOA -V -n -np -cell_name inv_x2 -lib_name ece6443lib -view_name layout \
	-extracted_view sv_extracted -extview_rul \
	/ip/cadence/gpdk045/gpdk045_v_6_0/pvs/extview.rul -hf caps2dversion \
	-m -FN NET -o  HSPICE -g ${CAP_GROUND} -cc -c capfile -xrPm res.mod \
	np_rpoly_0conn.res np_rmetal1_0conn.res rcont_0poly.res \
	rcont_0pdiff_metal1_0conn_pdiff_0conn.res \
	rcont_0ndiff_metal1_0conn_ndiff_0conn.res -xrPm mwires.mod mwires.res \
	-xta lvsmos.mod,_0nmos1v.net _0nmos1v.transr,_0nmos1v -xta \
	lvsmos.mod,_0pmos1v.net _0pmos1v.transr,_0pmos1v -ls slab -li \
	mport_lab -lp L1T0 oa2xdspf.dspf
