...
# This script was generated Wed Apr 29 18:06:43 2026 by:
#
...
#	-add_bulk_terminal yes -ev2 -cell_name inv_x1 -view_name layout \
...
qrcToOA -V -n -np -cell_name inv_x1 -lib_name ece6443lib -view_name layout \
